    ...
    this.render = function() {
        ...
        if (numberEntered == 0) {
            ...
            while (counter < (numberEntered - 1)) {
                ...
                counter++;
                 document.getElementById('dialogboxbody').innerHTML = fib; document.getElementById('dialogboxbody').innerHTML = fib; document.getElementById('dialogboxbody').innerHTML = fib;
            }
